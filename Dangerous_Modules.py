...
def profile_menu():
    ...
    while True:
        ...
        if pro_choice == "1":
            ...
            print("Your current username is " + str(content[0:1]) + ".")
...
def show_inventory():
    global user_funds, user_inventory, user_spent, user_role
    while True:
        print("Current Inventory Available:")
        item_01 = '1) Questionable Cheese, 50, ★, "If you scrape the fuzzy stuff off, it should be fine."'
        print(item_01)
        item_02 = '2) Nail Bread, 100, ★, "It appears to be a slice of bread with a nail poking out the top."'
        print(item_02)
        item_03 = '3) Cursed Amulet, 200, ★★, "Wear this and you too can know the joy of curses."'
        print(item_03)
        item_04 = '4) Midas Glove, 225, ★★★, "Turns anything it touches into gold. ANYTHING."'
        print(item_04)
        item_05 = '5) Supersonic Hypercube, 300, ★★★, "With a name like that, how could it be bad?"'
        print(item_05)
...
def SQL_inventory():
    ...
    cursor = cnx.cursor()
    view_inv = "SELECT * FROM Inventory;"
    cursor.execute(view_inv)
    fa = cursor.fetchall()
    print(fa)
